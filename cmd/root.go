...
import (
	...
	dbInfra "github.com/MatheusNP/fc-ports-adapters/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fc-ports-adapters.yaml)")
